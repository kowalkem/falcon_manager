...
class Falcon(models.Model):
    ...
    species = models.ForeignKey(
        'Species', on_delete=models.CASCADE, related_name='_species', null=True, blank=True)
    ...
    in_pair = models.ForeignKey(
        'Pair', on_delete=models.CASCADE, null=True, blank=True)
    father = models.ForeignKey(
        'self', on_delete=models.CASCADE, related_name='_father', null=True, blank=True)
    mother = models.ForeignKey(
        'self', on_delete=models.CASCADE, related_name='_mother', null=True, blank=True)
    siblings = models.ManyToManyField(
        'self', related_name='_sibling', blank=True)
    ...
    photos_young = models.ForeignKey(
        'Photo', on_delete=models.CASCADE, related_name='_photos_young', null=True, blank=True)
