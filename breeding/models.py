...
class Falcon(models.Model):
    ...
    CITES_img = models.ImageField(null=True, blank=True)
    registration_img = models.ImageField(null=True, blank=True)
    RDOS_permission_img = models.ImageField(null=True, blank=True)
    ...
    photos_young = models.ImageField(null=True, blank=True)
